        ...
        <header className="fixed w-full top-0 inset-x-0 z-50">
            ...
            <motion.div
                ...
                className={cn(
                    ...
                    visible && "bg-background/60 py-4 pl-2 border border-t-foreground/20 border-b-foreground/10 border-x-foreground/15 w-full"
                )}
            >
                <Wrapper className="flex items-center justify-between lg:px-4">
                    ...
                    <div className="hidden lg:flex flex-row flex-1 absolute inset-0 items-center justify-center w-max mx-auto gap-x-2 text-sm text-muted-foreground font-medium flex-grow">
                        <AnimatePresence>
                ...
                <AnimatePresence>
                    {open && (
                        <motion.div
                            ...
                            animate={{ opacity: 1 }}
                            exit={{ opacity: 0 }}
                            className="flex rounded-b-xl absolute top-16 bg-neutral-950 inset-x-0 z-50 flex-col items-start justify-start gap-2 w-full px-4 py-8 shadow-xl shadow-neutral-950 select-none"
                        >
                            ...
                            <AnimationContainer animation="fadeUp" delay={0.5} className="w-full space-y-4 select-none">
                                <>
